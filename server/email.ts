...
export async function sendVerificationEmail(
  ...
  await transporter.sendMail({
    ...
    html: `
      ...
      <body style="margin: 0; padding: 0; background-color: #fafafa; font-family: 'Funnel Display', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
              ...
              <table role="presentation" style="max-width: 480px; margin: 0 auto; background-color: #f5f5f5; border-radius: 16px; overflow: hidden; border: 1px solid #e5e5e5;">
                ...
                <tr>
                  <td style="padding: 40px;">
                    <h2 style="margin: 0 0 16px 0; color: #171717; font-size: 20px; font-weight: 600; font-family: 'Funnel Display', sans-serif;">Welcome aboard, ${name}!</h2>
                    <p style="margin: 0 0 28px 0; color: #525252; font-size: 15px; line-height: 1.7; font-family: 'Funnel Display', sans-serif;">
                    ...
                    <table role="presentation" style="width: 100%; border-collapse: collapse;">
                      <tr>
                        <td style="text-align: center; padding: 8px 0 32px 0;">
                          <a href="${verificationUrl}" style="display: inline-block; background-color: #FACC15; color: #171717; text-decoration: none; padding: 14px 32px; border-radius: 8px; font-size: 15px; font-weight: 600; font-family: 'Funnel Display', sans-serif; border: 1px solid #E5B800;">
                            Verify My Email
                          </a>
                        </td>
                      </tr>
                    </table>
                    <p style="margin: 0 0 8px 0; color: #737373; font-size: 13px; font-family: 'Funnel Display', sans-serif;">Or copy this link:</p>
                    ...
                    <p style="margin: 0; color: #737373; font-size: 13px; font-family: 'Funnel Display', sans-serif;">This link expires in 24 hours.</p>
                  </td>
                </tr>
                <!-- Footer -->
                <tr>
                  <td style="padding: 24px 40px; background-color: #ebebeb; border-top: 1px solid #e0e0e0;">
                    <p style="margin: 0; color: #737373; font-size: 12px; text-align: center; font-family: 'Funnel Display', sans-serif;">
...
export async function sendStreakReminderEmail(
  ...
  await transporter.sendMail({
    ...
    html: `
      ...
      <body style="margin: 0; padding: 0; background-color: #1a1a1a; font-family: 'Funnel Display', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
        <table role="presentation" style="width: 100%; border-collapse: collapse;">
          <tr>
            <td style="padding: 40px 20px;">
              <table role="presentation" style="max-width: 480px; margin: 0 auto; background-color: #262626; border-radius: 20px; overflow: hidden; border: 1px solid #404040;">
                ...
                <tr>
                  <td style="background: linear-gradient(135deg, #F97316 0%, #EA580C 50%, #C2410C 100%); padding: 48px 40px; text-align: center;">
                    ...
                    <h1 style="margin: 0; color: #ffffff; font-size: 42px; font-weight: 800; letter-spacing: -1px; font-family: 'Funnel Display', sans-serif; text-shadow: 0 2px 4px rgba(0,0,0,0.2);">${currentStreak}</h1>
                    <p style="margin: 8px 0 0 0; color: rgba(255,255,255,0.9); font-size: 14px; font-weight: 600; letter-spacing: 3px; text-transform: uppercase; font-family: 'Funnel Display', sans-serif;">Day Streak</p>
                  </td>
                </tr>
                <!-- Content -->
                <tr>
                  <td style="padding: 40px;">
                    <h2 style="margin: 0 0 12px 0; color: #ffffff; font-size: 24px; font-weight: 700; font-family: 'Funnel Display', sans-serif;">${headline}</h2>
                    <p style="margin: 0 0 32px 0; color: #a3a3a3; font-size: 16px; line-height: 1.7; font-family: 'Funnel Display', sans-serif;">
                    ...
                    <table role="presentation" style="width: 100%; border-collapse: collapse; margin-bottom: 32px;">
                      <tr>
                        <td style="background-color: #1a1a1a; border-radius: 12px; padding: 20px; text-align: center; border: 1px solid #404040;">
                          <p style="margin: 0 0 4px 0; color: #F97316; font-size: 28px; font-weight: 800; font-family: 'Funnel Display', sans-serif;">${currentStreak} days</p>
                          <p style="margin: 0; color: #737373; font-size: 12px; text-transform: uppercase; letter-spacing: 1px; font-family: 'Funnel Display', sans-serif;">Current Streak</p>
                        </td>
                      </tr>
                    </table>
                    <!-- CTA Button -->
                    <table role="presentation" style="width: 100%; border-collapse: collapse;">
                      <tr>
                        <td style="text-align: center;">
                          <a href="${dashboardUrl}" style="display: inline-block; background: linear-gradient(135deg, #F97316 0%, #EA580C 100%); color: #ffffff; text-decoration: none; padding: 16px 40px; border-radius: 12px; font-size: 16px; font-weight: 700; font-family: 'Funnel Display', sans-serif; box-shadow: 0 4px 14px rgba(249, 115, 22, 0.4);">
                    ...
                    <table role="presentation" style="width: 100%; border-collapse: collapse;">
                      <tr>
                        <td style="background-color: #1a1a1a; border-radius: 12px; padding: 20px; border-left: 4px solid #F97316;">
                          <p style="margin: 0; color: #d4d4d4; font-size: 14px; font-style: italic; line-height: 1.6; font-family: 'Funnel Display', sans-serif;">
                ...
                <tr>
                  <td style="padding: 24px 40px; background-color: #1a1a1a; border-top: 1px solid #404040;">
                    <p style="margin: 0 0 8px 0; color: #737373; font-size: 12px; text-align: center; font-family: 'Funnel Display', sans-serif;">
                      You're receiving this because you're awesome and have an active streak on Prepetual.
                    </p>
                    <p style="margin: 0; color: #525252; font-size: 11px; text-align: center; font-family: 'Funnel Display', sans-serif;">
          ...
          <tr>
            <td style="padding: 40px 20px;">
              <table role="presentation" style="max-width: 480px; margin: 0 auto; background-color: #f5f5f5; border-radius: 16px; overflow: hidden; border: 1px solid #e5e5e5;">
                ...
                <tr>
                  <td style="padding: 40px;">
                    <h2 style="margin: 0 0 16px 0; color: #171717; font-size: 20px; font-weight: 600; font-family: 'Funnel Display', sans-serif;">Reset your password</h2>
                    <p style="margin: 0 0 8px 0; color: #525252; font-size: 15px; line-height: 1.7; font-family: 'Funnel Display', sans-serif;">
                      Hi ${name},
                    </p>
                    <p style="margin: 0 0 28px 0; color: #525252; font-size: 15px; line-height: 1.7; font-family: 'Funnel Display', sans-serif;">
                    ...
                    <table role="presentation" style="width: 100%; border-collapse: collapse;">
                      <tr>
                        <td style="text-align: center; padding: 8px 0 32px 0;">
                          <a href="${resetUrl}" style="display: inline-block; background-color: #FACC15; color: #171717; text-decoration: none; padding: 14px 32px; border-radius: 8px; font-size: 15px; font-weight: 600; font-family: 'Funnel Display', sans-serif; border: 1px solid #E5B800;">
                            Reset Password
                          </a>
                        </td>
                      </tr>
                    ...
                    <p style="margin: 0; color: #737373; font-size: 13px; font-family: 'Funnel Display', sans-serif;">This link expires in 1 hour.</p>
                  </td>
                </tr>
                <!-- Footer -->
                <tr>
