...
const motivationalMessages = [
  ...
  { streak: 3, message: "Three days! You're on fire!", subtext: "Your dedication is inspiring." },
  { streak: 4, message: "Four days in a row! Amazing!", subtext: "Keep the momentum going!" },
  { streak: 5, message: "Five days! That's a whole school week!", subtext: "You're forming a powerful habit." },
  { streak: 6, message: "Six days strong! Almost a full week!", subtext: "You're unstoppable!" },
  ...
  { streak: 21, message: "21 days! Habits are now locked in.", subtext: "Learning is now part of who you are." },
